...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setDownloadError("");
      setConvertMessage("Conversion Successful");
    } catch (error) {
      console.error(error);
      if (error.response) {
        ...
        setConvertMessage("An unexpected error occurred. Please try again later.");
      }
    }
  };
      ...
      <div className="flex h-screen items-center justify-center">
        <div className="border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg">
          ...
          <p className="text-sm text-center mb-5">
            Convert your Word file to PDF in a very easy and efficient manner
          </p>
          <div className="flex flex-col items-center space-y-4">
            ...
            <button
              ...
              className="text-white bg-blue-500 hover:bg-blue-700 disabled:bg-gray-400 disabled:pointer-events-none duration-300 font-bold px-4 py-2 rounded"
            >
              Convert File
            </button>
            {convertMessage && (
